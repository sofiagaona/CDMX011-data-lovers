...
/*import sortData from '../src/data';
//import filtrar from '../src/main';
...
describe('filter', () => {
  ...
  describe('Test unitarios de nuestro módulo ', () => {
    it('debería ser una funcion', () => {
      expect(sortData(data.pokemon,"Alfabetico","Ascendente")).toBe(sortData(data.pokemon,"Alfabetico","Ascendente") == Object);
    });

    it('Squirtle', () => {
      expect(filterData(data,"name","squirtle")).toBe(Object);
    });
    it('debería retornar true para "4083952015263"', () => {
      expect(filterData('4083952015263')).toBe(true);
    });
    it('debería retornar true para "79927398713"', () => {
      expect(filterData('79927398713')).toBe(true);
    });
    it('debería retornar false para "1234567890"', () => {
      expect(filterData('1234567890')).toBe(false);
    });
  });*/
